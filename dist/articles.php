      ...
      <div class="container">
        <div class="row articles__item">
          <div class="col-md-3 content-block-image">
            <img src="img/articles_1.jpg" title="doc-image" alt="doc-image">
          </div>
        ...
        <div class="row articles__item">
          <div class="col-md-3 content-block-image">
            <img src="img/articles_2.jpg" title="doc-image" alt="doc-image">
          </div>
          <div class="col-md-9 articles-descript">
            <div>
              <h2 class="h2">
        ...
        <div class="row articles__item">
          <div class="col-md-3 content-block-image">
            <img src="img/articles_3.jpg" title="doc-image" alt="doc-image">
          </div>
          <div class="col-md-9 articles-descript">
            <div>
              <h2 class="h2">
        ...
        <div class="row articles__item">
          <div class="col-md-3 content-block-image">
            <img src="img/articles_4.jpg" title="doc-image" alt="doc-image">
          </div>
          <div class="col-md-9 articles-descript">
            <div>
              <h2 class="h2">
