...
<html lang="en">
  ...
  <body>
    ...
    <div class="text-content content-block content-block_gray">
      <div class="container">
        <p class="paragraph">
          Вам нужно пробить номер машины? Наша база автомобильных номеров создана  специально для вас.
        </p>
        <p class="paragraph">
          В нашей колекции номеров собраны именные номера, крутые номера (государственные регистрационные номера с одинаковыми цифрами и т.д.) со всей Украины. Наша база номеров автомобилей может помоч вам составить свой именной номер, посмотрев примеры номеров, которые уже есть у владельцев. Наша база автомобильных номеров - одна из самых больших в Украине.
        </p>
        <p class="paragraph">
          База автомобильных номеров - <b>временно не доступна</b>.
        </p>
      </div>
    </div>
